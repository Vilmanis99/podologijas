          ...
          <div className="relative grid md:grid-cols-[1fr_auto] gap-8 md:gap-12 items-center">
            <div>
              ...
              <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl text-white leading-[1.1] mb-4">
                Pilna pēdu aprūpe
                <br />
                <span className="text-secondary-container">par 30 €</span>
              </h2>
              <p className="text-white/75 text-base md:text-lg leading-relaxed max-w-xl">
                Klientiem 65+ piedāvājam īpašu cenu ārstnieciskajai pēdu aprūpei
                darba dienās no plkst. <span className="text-white font-semibold">9:00 līdz 13:00</span>.
                Rūpīga, profesionāla aprūpe par pieejamu cenu.
              </p>
            </div>
